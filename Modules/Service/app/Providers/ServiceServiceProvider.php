...
class ServiceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->register(RouteServiceProvider::class);
                $this->app->bind(ServicePackageRepository::class, function ($app) {
            return new ServicePackageRepository(new ServicePackage());
        });

        $this->app->bind(ServicePackageService::class, function ($app) {
            return new ServicePackageService($app->make(ServicePackageRepository::class));
        });
    }
